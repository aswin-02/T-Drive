    ...
    $.fn.pptxToHtml = function( options ) {
        ...
        if(settings.slideMode){
            if(!jQuery().divs2slides) {
                jQuery.getScript('js/divs2slides.html');
            }
        }
        ...
        function processPPTX(zip) {
            ...
            if (zip.file("docProps/thumbnail.html") !== null) {
                var pptxThumbImg = base64ArrayBuffer(zip.file("docProps/thumbnail.html").asArrayBuffer());
               post_ary.push({
                    "type": "pptx-thumb",
                    "data": pptxThumbImg
                });
            ...
            tableStyles = readXmlFile(zip, "ppt/tableStyles.html");
        ...
        function getContentTypes(zip) {
            var ContentTypesJson = readXmlFile(zip, "%5bContent_Types%5d.html");
        ...
        function getSlideSize(zip) {
            ...
            var rtenObj = {};
            var content = readXmlFile(zip, "ppt/presentation.html");
        ...
        function processSingleSlide(zip, sldFileName, index, slideSize) {
            ...
            */
                ...
                for (var i=0; i<RelationshipArray.length; i++) {
                    switch (RelationshipArray[i]["attrs"]["Type"]) {
                        case "http://schemas.openxmlformats.org/officeDocument/2006/relationships/slideLayout":
                            layoutFilename = RelationshipArray[i]["attrs"]["Target"].replace("https://templates.iqonic.design/cloudbox/html/", "ppt/index.html");
                            break;
                        ...
                        default:
                            slideResObj[RelationshipArray[i]["attrs"]["Id"]] = {
                                ...
                                "target": RelationshipArray[i]["attrs"]["Target"].replace("https://templates.iqonic.design/cloudbox/html/", "ppt/index.html")
                            };
                    }
                }
            } else {
                layoutFilename = RelationshipArray["attrs"]["Target"].replace("https://templates.iqonic.design/cloudbox/html/", "ppt/index.html");
            }
            ...
            if (RelationshipArray.constructor === Array) {
                for (var i=0; i<RelationshipArray.length; i++) {
                    switch (RelationshipArray[i]["attrs"]["Type"]) {
                        case "http://schemas.openxmlformats.org/officeDocument/2006/relationships/slideMaster":
                            masterFilename = RelationshipArray[i]["attrs"]["Target"].replace("https://templates.iqonic.design/cloudbox/html/", "ppt/index.html");
                            break;
                        default:
                ...
                masterFilename = RelationshipArray["attrs"]["Target"].replace("https://templates.iqonic.design/cloudbox/html/", "ppt/index.html");
            }
            ...
            if (RelationshipArray.constructor === Array) {
                for (var i=0; i<RelationshipArray.length; i++) {
                    switch (RelationshipArray[i]["attrs"]["Type"]) {
                        case "http://schemas.openxmlformats.org/officeDocument/2006/relationships/theme":
                            themeFilename = RelationshipArray[i]["attrs"]["Target"].replace("https://templates.iqonic.design/cloudbox/html/", "ppt/index.html");
                            break;
                        default:
                ...
                themeFilename = RelationshipArray["attrs"]["Target"].replace("https://templates.iqonic.design/cloudbox/html/", "ppt/index.html");
            }
