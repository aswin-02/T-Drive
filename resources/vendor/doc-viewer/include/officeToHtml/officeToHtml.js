...
(function ($) {
    ...
    function getPdfContent(fObj, divId, pdfSet) {
        ...
        var currentScriptPath = function () {
            ...
            var name = dir.split('https://templates.iqonic.design/').pop();
        ...
        if (pdfScriptPath.indexOf(full_path) > -1) {
            var link_a_array = pdfScriptPath.split("https://templates.iqonic.design/");
            var link_b_array = full_path.split("https://templates.iqonic.design/");
            var link_diff = diff2(link_a_array, link_b_array).join("https://templates.iqonic.design/");
    ...
    /***/ (function (module, exports, __webpack_require__) {
        ...
        /***/ (function (module, exports, __webpack_require__) {
                ...
                function configure(PDFJS) {
                    PDFJS.imageResourcesPath = "images/index.html";
                ...
                var validateFileURL = void 0;
                {
                    ...
                    validateFileURL = function validateFileURL(file) {
                        ...
                        try {
                            var viewerOrigin = new URL(window.location.html).origin || 'null';
                            if (HOSTED_VIEWER_ORIGINS.indexOf(viewerOrigin) >= 0) {
                                return;
                            }
                            var fileOrigin = new URL(file%2c%20window.location.html).origin;
        ...
        /***/ (function (module, exports, __webpack_require__) {
                ...
                window.print = function print() {
                    ...
                    ensureOverlay().then(function () {
                        if (activeService) {
                            overlayManager.open('printServiceOverlay.html');
                        }
                    });
                    try {
        ...
        /***/ (function (module, exports, __webpack_require__) {
                ...
                document.webL10n = function (window, document, undefined) {
                    ...
                    function xhrLoadText(url, onSuccess, onFailure) {
                        ...
                        var xhr = new XMLHttpRequest();
                        xhr.open('GET.html', url, gAsyncResourceLoading);
